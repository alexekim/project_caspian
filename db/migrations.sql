...
CREATE TABLE contacts (id SERIAL PRIMARY KEY, phone VARCHAR(255), address VARCHAR(255), city VARCHAR(255), state VARCHAR(255), zipcode VARCHAR(255), country VARCHAR(255), ice_name VARCHAR(255), ice_relation VARCHAR(255), ice_phone INTEGER;
...
CREATE TABLE camp_locations (id SERIAL PRIMARY KEY, description VARCHAR(255);
